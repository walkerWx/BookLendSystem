...
import edu.nju.booklend.data.service.jpa.LoginServiceImpl;
...
public class AdminLoginView extends JFrame{
	...
	public void init(){
		...
		loginIcon=new ImageIcon(path+"//images//button.png");
		loginIcon.setImage(loginIcon.getImage().getScaledInstance(70, 20, Image.SCALE_DEFAULT));
	
		jPanel=new LoginBackgroundJPanel();
...
class LoginBackgroundJPanel extends JPanel{
